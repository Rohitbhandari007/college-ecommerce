...
class GeneralProduct(models.Model):
    ...
    DEFAULT_IMAGE_URL = 'https://media.istockphoto.com/id/1295274245/photo/random-multicolored-spheres-computer-generated-abstract-form-of-large-and-small-balls-3d.jpg?b=1&s=170667a&w=0&k=20&c=On1rcMZtCPflzFJP6Wc2Y5GiRy0w0j1RA52FH-0EUX0='
    ...
    product_img1 = models.ImageField(
        upload_to='products/', blank=True, null=True, default=DEFAULT_IMAGE_URL, max_length=10000)
